...
def get_full_data():
    ...
    client.get_oauth_session('eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1bmlxdWVfbmFtZSI6IjU1NjM4MzAwIiwicm9sZSI6InpJSW1CdkhRY0tTMzdLTmJlZkxuNU5PczZpb2lZQUNtIiwiU3RhdGUiOiIiLCJuYmYiOjE3MDkzNjExMjQsImV4cCI6MTcwOTM2MTE4NCwiaWF0IjoxNzA5MzYxMTI0fQ.LpKmskKSVDwUEPoEkYBq_hwsXobiVXOjQgxpiFt2f20')
    ...
    cur.execute('''DROP TABLE IF EXISTS NINDEX_OHLC_1D''')
    
    df_full.to_sql('NINDEX_OHLC_1D', conn, if_exists='replace', index=True) # - writes the pd.df to SQLIte DB
